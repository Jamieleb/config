...
local webpack = Terminal:new({
	cmd = "nvm use && yarn && ./bin/webpack-dev-server",
	hidden = true,
	close_on_exit = true,
})
...
function _rails_models()
	custom_tele.search_path("./app/models/", "Models")
end
function _rails_controllers()
	custom_tele.search_path("./app/controllers/", "Controllers")
end
function _rails_views()
	custom_tele.search_path("./app/views/", "Views")
end
function _rails_services()
	custom_tele.search_path("./app/services/", "Services")
end
function _rails_resources()
	custom_tele.search_path("./app/resources/", "Resourcees")
end
function _rails_components()
	custom_tele.search_path("./app/webpacker/components/", "Services")
end
