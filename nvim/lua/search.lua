...
wk.register({
  s = {
    name = 'search',
    ['/'] = { "<cmd>lua require('telescope.builtin').grep_string({ search = vim.fn.input('Grep for > ') })<CR>", 'Grep code base' },
    f = { '<cmd>lua require("telescope.builtin").find_files()<CR>', 'files' },
    R = { '<cmd>lua require("telescope.builtin").old_files()<CR>', 'recent files' },
    ...
    g = { '<cmd>lua require("telescope.builtin").gh pull_requests()<CR>', 'pull requests' },
    ...
    a = { '<cmd>lua require("telescope.builtin").lsp_code_actions(require("telescope.themes").get_dropdown({}))<CR>', 'code actions' },
