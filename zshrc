...
alias m2="cd ~/Projects/mosaic-v2"
alias ssh_prod="cx lease -s 'Mosaic' -e production -p 22 -t 10 -f 0.0.0.0/0 && cx ssh -s 'Mosaic' -e production deer"
...
# Should enable vim mode in rails console. https://stackoverflow.com/questions/18818412/how-to-do-vi-style-navigation-in-rail-console
bindkey -v
